...
def translate_batch(texts_map, lang_to, model="gpt-5-nano"):
    ...
    contents = [
        ...
        "   - If a term is a Proper Noun (e.g., 'Dyson Sphere', 'Icarus'), keep the ORIGINAL. For technical terms (e.g., 'Power', 'Iron'), TRANSLATE them into {lang_to} using the context.",
        "   - NEVER return explanations like 'I cannot translate'.",
        "",
        "2. **Constraints**:",
        "   - STRICTLY preserve leading and trailing whitespace padding.",
        "   - **Character Budget**: The target language might be longer, but for game UIs you MUST stay as close as possible to the 'len' value.",
